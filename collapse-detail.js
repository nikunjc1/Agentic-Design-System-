(() => {
  ...
  function cssBlock(){
    ...
    lines.push('.collapse-demo-header-text{ font-size:13px; font-weight:600; color:var(--text-hi); }');
    ...
    lines.push('.collapse-demo-body{ padding:0 14px 14px; font-family:var(--font-body); font-size:13px; color:var(--text-mid); }');
