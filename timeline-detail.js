(() => {
  ...
  function buildFullCode(showIcons){
    ...
    lines.push(".timeline-demo-title{ font-family:var(--font-body); font-size:13px; font-weight:600; color:var(--text-hi); }");
    lines.push(".timeline-demo-title.is-current{ color:var(--red-400); }");
    lines.push(".timeline-demo-time{ font-family:var(--font-body); font-size:11px; color:var(--text-dim); margin-top:2px; }");
    lines.push("");
    ...
    lines.push("   (1 or 3) flips per item, alternating which side it sits on */");
